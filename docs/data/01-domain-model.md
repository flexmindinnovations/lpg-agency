...
| **Generic Domain** | Customer Management, Notifications, Reporting, Identity & Access, Tenant Administration | Product Owner |
...
### 4.1 Tenant
- **Entities:** Branch, Warehouse, TenantConfiguration
- **Value Objects:** TenantStatus, SubscriptionPlan
- **Lifecycle:** `Provisioned → Trial/Active → Suspended(optional) → Closed`. Never hard-deleted.
