...
from sqlalchemy import ForeignKey, String, Text, MetaData, TIMESTAMP
...
class ComplaintModel(Base):
    ...
    __table_args__ = {"schema": "complaint"}
    ...
    resolution: Mapped["ComplaintResolutionModel | None"] = relationship(
        "ComplaintResolutionModel", back_populates="complaint", cascade="all, delete-orphan", uselist=False
    )
...
class ComplaintAssignmentModel(Base):
    ...
    complaint_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("complaint.complaint.id", ondelete="CASCADE"), nullable=False)
    ...
    complaint: Mapped["ComplaintModel"] = relationship("ComplaintModel", back_populates="assignments")
...
class ComplaintResolutionModel(Base):
    ...
    complaint: Mapped["ComplaintModel"] = relationship("ComplaintModel", back_populates="resolution")
