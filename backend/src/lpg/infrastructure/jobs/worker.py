...
from lpg.infrastructure.jobs.refill_jobs import predict_refill_due
...
class WorkerSettings:
    ...
    cron_jobs: ClassVar = [
        ...
        # 01:45 — after the feature store build, so today's customer_refill
        # snapshots already exist.
        cron(predict_refill_due, hour=1, minute=45),
