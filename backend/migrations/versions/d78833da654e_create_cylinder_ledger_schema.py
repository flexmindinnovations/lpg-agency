...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_cylinder_ledger_customer"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenant.tenant.id"],
            name=op.f("fk_cylinder_ledger_tenant"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cylinder_ledger_id"],
            ["cylinder_ledger.cylinder_ledger.id"],
            name=op.f("fk_ledger_transaction_cylinder_ledger"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["cylinder_type_id"],
            ["tenant.cylinder_type.id"],
            name=op.f("fk_ledger_transaction_cylinder_type"),
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenant.tenant.id"],
            name=op.f("fk_ledger_transaction_tenant"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cylinder_ledger_id"],
            ["cylinder_ledger.cylinder_ledger.id"],
            name=op.f("fk_cylinder_balance_cylinder_ledger"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["cylinder_type_id"],
            ["tenant.cylinder_type.id"],
            name=op.f("fk_cylinder_balance_cylinder_type"),
        ),
        sa.ForeignKeyConstraint(
            ["last_transaction_id"],
            ["cylinder_ledger.ledger_transaction.id"],
            name=op.f("fk_cylinder_balance_ledger_transaction"),
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["tenant.tenant.id"],
            name=op.f("fk_cylinder_balance_tenant"),
            ondelete="CASCADE",
        ),
