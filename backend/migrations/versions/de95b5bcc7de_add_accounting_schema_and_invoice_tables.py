...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["customer_id"], ["customer.customer.id"], name=op.f("fk_invoice_customer")
        ),
        sa.ForeignKeyConstraint(["order_id"], ["orders.order.id"], name=op.f("fk_invoice_order")),
        sa.ForeignKeyConstraint(
            ["tenant_id"], ["tenant.tenant.id"], name=op.f("fk_invoice_tenant"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_invoice_line_cylinder_type"),
        ),
        sa.ForeignKeyConstraint(
            ["invoice_id"],
            ["accounting.invoice.id"],
            name=op.f("fk_invoice_line_invoice"),
            ondelete="CASCADE",
        ),
