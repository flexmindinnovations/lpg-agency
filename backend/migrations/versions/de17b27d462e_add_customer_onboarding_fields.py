...
def upgrade() -> None:
    ...
    op.add_column(
        "customer", sa.Column("email", sa.String(length=200), nullable=True), schema="customer"
    )
    op.add_column(
        "customer", sa.Column("date_of_birth", sa.Date(), nullable=True), schema="customer"
    )
    op.alter_column(
        "customer",
        "consumer_number",
    ...
    op.add_column(
        "customer_address",
        sa.Column("line_1", sa.Text(), nullable=False, server_default=""),
        schema="customer",
    )
    op.add_column(
        "customer_address", sa.Column("line_2", sa.Text(), nullable=True), schema="customer"
    )
    op.add_column(
        "customer_address",
    ...
    op.add_column(
        "customer_address",
        sa.Column("address_type", sa.String(length=50), server_default="delivery", nullable=False),
        schema="customer",
    )
    ...
    op.add_column(
        "kyc_document",
        sa.Column("document_number", sa.Text(), nullable=False, server_default=""),
        schema="customer",
    )
    op.add_column(
        "kyc_document", sa.Column("file_url", sa.Text(), nullable=True), schema="customer"
    )
    op.add_column(
        "kyc_document", sa.Column("issue_date", sa.Date(), nullable=True), schema="customer"
    )
    op.add_column(
        "kyc_document", sa.Column("expiry_date", sa.Date(), nullable=True), schema="customer"
    )
    op.add_column(
        "kyc_document", sa.Column("rejection_reason", sa.Text(), nullable=True), schema="customer"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "kyc_document",
        sa.Column("doc_reference", sa.Text(), nullable=False, server_default=""),
        schema="customer",
    )
    ...
    op.add_column(
        "customer_address",
        sa.Column("address_line", sa.Text(), nullable=False, server_default=""),
        schema="customer",
    )
